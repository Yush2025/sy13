...
{rb6}    ╚═════╝  ╚════╝  ╚════╝ ╚═════╝    ╚═╝   ╚═╝╚═╝  ╚══╝ ╚═════╝ 
    {BG}                                                             {RW}
    {BG}                {Z1} {Q}𝘽 𝙊 𝙊 𝙎 𝙏 𝙄 𝙉 𝙂   𝙏 𝙊 𝙊 𝙇 𝙎  {BG}               {RW}
    {BG}                                                             {BG}{RW}
    {BG}  {Z1}Uses :{RW} {Z1}BOOSTING TOOLS {BG}                                     {RW}
    {BG}  {Z1}Tools :{RW} {Z1}PREMIUM{BG}                                            {RW}
    {BG}  {Z1}Boost only :{RW} {blue}Facebook {BG}                                     {RW}
    {BG}  {Z1}Version : {BG1} 10.7  {BG}                                          {RW}
    {BG}  {Z1}Status : {BG1}Active {BG}                                           {RW}
    {BG}  {Z1}Country : {BG1}Philippines {BG}                                     {RW}
    {BG}  {Z1}Tools :{BG1} Paided {BG}                                            {RW}
    {BG}  {Z1}Service Status {Z1}⤵                                           {RW}  
    {BG}                 {Z3} online  {blue}( {Z1}•{blue} )                              {RW}
    {BG}              {Z3}    offline {blue}( {red}• {blue})                              {RW}
    {BG}                                                             {BG}{RW}
    {BG}                    {Z1}DEVELOPER :{RW} {Q}HANZY {BG}                       {RW}
    {BG}                                                             {RW}
    {BG}  {Z4} ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━{BG}   {RW} """)
...
def count_lines_in_files(*file_paths):
    for i, file_path in enumerate(file_paths, start=1):
        try:
            ...
            if i == 1: 
                print(f'''\t\t  {BG} {P}       FRA ACCOUNT {R}: {green}{total_lines}       {RW } ''')
...
def main():
    ...
    linex()
    print(f'''    {BG}                                                             {RW} ''')
    print(f'''    {BG}{Z2}  1   {Z1}Premium {Z3}Tools                                          {RW}''')
    print(f'''    {BG}{Z2}  2     {C6}Note {yellow}: {Z1}Gradual Processing                            {RW} ''')
    print(f'''    {BG}{Z2}  3       {Q6}Boosting {Q6}Tool Overview                             {RW}''')
    print(f'''    {BG}{Z2}  4  {Z4}    │ {Z5}01  {Q}Add Facebook Account Version 1                {RW} ''')
    print(f'''    {BG}{Z2}  5 {Z4}     │ {Z5}02 {Q} Auto Reaction Without Care      {Z1}•             {RW} ''')
    print(f'''    {BG}{Z2}  6 {Z4}     │ {Z5}03 {Q} Auto Reaction With Care         {Z1}•             {RW} ''')
    print(f'''    {BG}{Z2}  7 {Z4}     │ {Z5}04  {Q2}Auto Reaction Comment           {Z1}•             {RW} ''')
    print(f'''    {BG}{Z2}  8{Z4}      │ {Z5}05  {Q2}Auto Reaction DP / COVER        {Z1}•             {RW} ''')
    print(f'''    {BG}{Z2}  9{Z4}      │ {Z5}06  {Q2}Auto Reaction Reels             {Z1}•             {RW}  ''')
    print(f'''    {BG}{Z2}  10 {Z4}    │{Z5} 07  {Q3}Auto Followers                  {Z1}•             {RW}  ''')
    print(f'''    {BG}{Z2}  12 {Z4}    │{Z5} 08  {Q3}Custom Comment                  {Z1}•             {RW}  ''') 
    print(f'''    {BG}{Z2}  13{Z4}     │{Z5} 09  {Q4}Custom Comment " Reels "        {Z1}•             {RW}  ''') 
    print(f'''    {BG}{Z2}  14 {Z4}    │{Z5}.10  {Q4}Custom Comment " DP "           {Z1}•             {RW}  ''')
    print(f'''    {BG}{Z2}  15 {Z4}    │{Z5}.11  {Q5}Auto Reply Comment              {Z1}•             {RW}  ''') 
    print(f'''    {BG}{Z2}  16{Z4}     │{Z5}.12 {Q5} Auto Share V1                   {Z1}•             {RW}  ''') 
    print(f'''    {BG}{Z2}  17{Z4}     │{Z5}.13 {Q6} Stored Page and Account         {Z1}•             {RW}  ''') 
    print(f'''    {BG}{Z2}  18 {Z4}    │{Z5}.14  {Q6}❝ Mass Facebook Report ❞        {Z1}•             {RW}  ''') 
    print(f'''    {BG}{Z2}  19  {Z4}   ╰───────────────────────────────────{Z5}  ヂ            {RW} ''')
    linex()
