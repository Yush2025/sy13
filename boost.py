...
{lime}┌────────────────────────{S}TOOLS INFORMATION{T} ────────────────────────────┐
{lime}│  {O}❯ {R}Uses     : {G}Boosting            {red}  ➙{white} Lifetime access                │
{lime}│  {O}❯ {R}Status   : {G} Active              {red} ➙ {white}No monthly Fee                 │
{T}│  {O}❯ {R}Tools    : {G}Paided/Premium       {red} ➙{white} Fast Process                   │
{T}│  {O}❯ {R}Network  : {G} All Network          {red}➙ {white}Customizable                   │
{T}│                                                   {red}    version {G}6.2   {white} │
{T}└──────────────────────────────────────────────────────────────────────┘
...
def main():
    ...
    print(f' {P}┃                  ┗━━━━━━━━━━━━━━━━━━━━━━━━━━━━┛       {P}            ┃''')
    print(f'''{P} ┃{white}  [01] {white}START TOOL                   {white}-  {red}[Log in account]       {P}     ┃''')
    print(f''' {P}┃{white}  [02] {blue}AUTO REACT W/O CARE          {white}-  {red}[Page & Normal Account]   {P}  ┃ ''')
    print(f'''{P} ┃{white}  [03] {blue}AUTO REACT WITH CARE         {white}-  {red}[Normal Account Only]     {P}  ┃''')
    print(f'''{P} ┃{white}  [04] {blue}AUTO REACT TO COMMENT        {white}-  {red}[Page & Normal Account]   {P}  ┃''')
    print(f'''{P} ┃{white}  [05] {blue}AUTO REACT TO DP & COVER     {white}-  {red}[Page & Normal Account]    {P} ┃''')
    print(f'''{P} ┃{white}  [06] {blue}AUTO REACT TO REELS          {white}-  {red}[Page & Normal Account]    {P} ┃''')
    print(f''' {P}┃{white}  [07] {blue}AUTO FOLLOW                  {white}-  {red}[Page & Normal Account]  {P}   ┃''')
    print(f'''{P} ┃{white}  [08] {blue}AUTO COMMENT TO POST         {white}-  {red}[Page & Normal Account]  {P}   ┃''')
    print(f''' {P}┃{white}  [09] {blue}AUTO COMMENT TO REELS        {white}-  {red}[Page & Normal Account]  {P}   ┃''')
    print(f'''{P} ┃{white}  [10] {blue}AUTO COMMENT TO DP           {white}-  {red}[Page & Normal Account]    {P} ┃''')
    print(f'''{P} ┃{white}  [11] {blue}REPLY TO COMMENT             {white}-  {red}[Page & Normal Account]   {P}  ┃''')
    print(f''' {P}┃{white}  [12] {blue}AUTO SHARE V2                {white}-  {red}[Normal Account Only]    {P}   ┃''')
    print(f'''{P} ┃{white}  [13] {blue}AUTO GROUP JOIN              {white}-  {red}[Facebook Page Only]  {P}      ┃''')
    print(f'''{P} ┃{white}  [14] {blue}LIKE & FOLLOW PAGE           {white}-  {red}[Facebook Page Only]    {P}    ┃''')
    print(f''' {P}┃{white}  [15] {blue}STORED PAGES AND ACCOUNT     {white}-  {red}[Page & Normal Account]  {P}   ┃''')
    print(f''' {P}┃{white}  [16] {cyan}RESET TOOL                   {white}-  {red}[ Restarting ]         {P}     ┃''')
    print(f'''{P} ┃{white}  [00] {red}EXIT                         {white}- {red} [Exit]               {P}       ┃''')
    print(f'''{P} ┗━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┛''')
    line()
