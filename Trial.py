...
slow_print("'\x1b[1;94m'Welcome to Tezuka Uy  Tools ", delay=0.15)
...
slow_print (" '\x1b[1;32m'.   SCRIPT ACCESS SUCCESSFUL" , delay=0.3)
def logo():
	print(f"""'\x1b[1;31m'
