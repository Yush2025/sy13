...
░░░╚═╝░░░░╚════╝░░╚════╝░╚══════╝╚═════╝░  ░░░╚═╝░░░░╚════╝░
  {P}  ╭──────────────────────────────────────────────────╮
  {P}  │             {R} AUTHOR ┊{M} ADMINS  {Y}           {P}        │
  {P}  │╭────────────────────────────────────────────────╮│
  {P}  ││ • {G} USES    :  {W}- {R}[ {H} BOOSTING TOOLS {R}  ]       {P}   ││
  {P}  ││ • {G} TOOLS   :  {W}- {R}[ {H} PAIDED/PREMIUM {R}  ]     {P}     ││
  {P}  ││ • {G} VERSION :  {W}- {R}[ {H} 6.0 {R}  ]     {P}                ││{P}                    │╰────────────────────────────────────────────────╯│
  {P}  ╰──────────────────────────────────────────────────╯
{G}      ┏━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┓ """)
##########LOGO SHARE##########
logo_share=(f"""{B}                
    ...
    try:
        ...
        if y == ("***"):
            if os.path.isfile("token_zari.txt"):
                status = (f"{G} Account Log in ✔ ")
            else:
                status = (f"{R}No account")
            print(f'{G}           Facebook account: {R}({status}{W}) ')
            if os.path.isfile("token_zari.txt"):
                status = (f" {G } ᯤ ")
            linex()
            print(f' {P}   ╭──────────────────────────────────────────────╮')
            print(f' {P}   │ {R} [01]{P} 📤 LOG IN       {W}- {R}[ {H} FACEBOOK LOGIN {R}]{B}  │')
            print(f' {P}   ╰──────────────────────────────────────────────╯ ')
            print(f' {P}   ││{S} [02]{W} 📤 AUTO SHARE   {W}- {R}[ {H} COOKIE LOG IN{R}  ]{B} ││')
            print(f' {P}   ││{S} [03]{W} 📤 AUTO COMMENT {W}- {R}[ {H}PAGE OR ACCOUNT{R} ] {B}││')
            print(f' {P}   ││{S} [04]{W} 📤 AUTO REACT   {W}- {R}[ {H}PAGE OR ACCOUNT{R} ] {B}││')
            print(f' {P}   ││{S} [05]{W} 📤 AUTO FOLLOW  {W}- {R}[ {H}PAGE OR ACCOUNT{R} ] {B}││')
            print(f' {P}   ││{S} [06]{W} 📤 REMOVE TOKEN {W}- {R}[ {H} DELETE TOKEN{R}   ] {B}││')
            print(f' {P}   ││{S} [07]{W} 📤 EXIT TOOLS   {W}- {R}[ {H}   EXIT HERE  {R}  ] {B}││')
            print(f' {P}   ││{S} [08]{W} 📤 INSTRUCTIONS {W}- {R}[ {H}   GUIDE HERE {R}  ]{B} ││')
            print(f' {P}   ╭──────────────────────────────────────────────╮')
            print(f' {P}   │ {R} [09]{P} 📤 ACCOUNT      {W}- {R}[ {H}   CHECKER {R}     ] {B} │')
            print(f' {P}   ╰──────────────────────────────────────────────╯ ')
            linex()
...
def login():
	...
	try:
		...
		print(f"{G}LOGIN SUCCESSFULLY");time.sleep(2)
		bot_share()
	except:
    ...
    try:
        ...
        for x in range(lmt):
            ...
            if "id" in post:
                ...
                print(f" {R}       {R}━━━━⊱   {G}𝐒 𝐔 𝐂 𝐂 𝐄 𝐒 𝐒 𝐅 𝐔 𝐋 𝐋 𝐘  𝐒 𝐄 𝐍 𝐓   {R} ⊰━━━━  ")
