...
{lightblue}│     {hotpink}          ░░░╚═╝░░░╚═╝╚═╝░░╚═╝░╚═════╝░╚═════╝░                {lightblue}      │
{lightblue}│                                                                 {blue}         │
{lightblue}╰──────────────────{C} D E V E L O P E R  N U G G E T S {lightblue}──────────────────────╯
 ╭────────{C}TOOL INFORMATION{B}─────────╮ {blue}   ╭────────{C}USER INFORMATION{B}─────────╮
 │ {red}•{hotpink} OWNER   : {green}BOSS MARCO      {blue}    │   {blue} │ {red}• {hotpink}STATUS   : {green}ACTIVE        {blue}     │
 ...
 │ {red}• {hotpink}VERSION : {green}5.5      {blue}           │{blue}    │ {red}• {hotpink}TOOLS    : {green}PAIDED       {blue}      │
 ╰─────────────────────────────────╯    ╰─────────────────────────────────╯""")
purple = "\033[1;35m"
blue = "\033[34m"
green = "\033[1;32m"
